...
const fullPathD = fs.readFileSync(__dirname + '/full_text_path.txt', 'utf8');

// Build logo.html with viewBox="150 220 720 460" so - LOVE GIVER - is 100% visible
const logoHtml = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Curio Wrap - Complete Watercolor Logo</title>
  <link rel="stylesheet" href="logo.css">
</head>
<body>

  <!-- Pure Code-Based Complete Watercolor Logo Component -->
  <div class="curio-logo-stage" id="curioLogo">
    <svg class="curio-logo-svg" viewBox="150 220 720 460" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Curio wraps - LOVE GIVER -">
      <defs>
        ...
        <!-- Color Palette Gradients matching reference photo -->
      ...
      <g transform="translate(0, 160)" class="watercolor-group">
        <!-- Base Layer: Outer Feathered Silhouette -->
        <path d="M 265,300 
      ...
      <!-- 2. Calligraphy Lettering AND Tagline - LOVE GIVER - -->
...
const letterVectorPath = "${fullPathD}";
...
(async () => {
  ...
  await page.screenshot({ path: '/Users/romit/Downloads/Dashboard/scratch/full_tagline_logo_preview.png' });
  await browser.close();
  console.log('Successfully rendered full_tagline_logo_preview.png');
})();
