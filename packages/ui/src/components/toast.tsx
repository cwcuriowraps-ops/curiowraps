        ...
        <AnimatePresence mode="sync">
          {toasts.map((toast) => (
            <motion.div
              ...
              className={cn(
                "pointer-events-auto flex w-full items-start gap-3 rounded-xl border p-4 backdrop-blur-md transition-all",
                colors[toast.type]
              )}
              role="alert"
            >
              ...
              <button
                ...
                className="text-xs font-bold opacity-60 hover:opacity-100 transition-opacity p-1 -mr-1"
